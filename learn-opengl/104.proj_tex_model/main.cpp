...
int main()
{
    ...
    std::string bowl_shader_vs_path(BASE_PATH);     bowl_shader_vs_path += "104.proj_tex_model/shader/bowl.vs";
    std::string bowl_shader_fs_path(BASE_PATH);     bowl_shader_fs_path += "104.proj_tex_model/shader/bowl.fs";
    ...
    std::string frustum_shader_vs_path(BASE_PATH);    frustum_shader_vs_path += "104.proj_tex_model/shader/frustum.vs";
    std::string frustum_shader_fs_path(BASE_PATH);    frustum_shader_fs_path += "104.proj_tex_model/shader/frustum.fs";
